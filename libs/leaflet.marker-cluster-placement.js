...
L.MarkerCluster.include({
  ...
  _regularPolygonVertexPlacement: function _regularPolygonVertexPlacement(
    vertexNo,
    totalVertices,
    centerPt,
    distanceFromCenter
  ...
  _generatePointsClocksCircles: function _generatePointsClocksCircles(
    count,
    centerPt,
    regularFirstCircle
  ) {
  ...
  _createHelpingCircle: function _createHelpingCircle(center, radius) {
    if (this._group.options.helpingCircles) {
      ...
      var clockCircle = new L.CircleMarker(
  ...
  _generatePointsConcentricCircles: function _generatePointsConcentricCircles(
    count,
    centerPt
  ) {
    var _this = this;
